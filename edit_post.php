...
<body>
    ...
    <form action="save_post.php" method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="nazev" id="nazev" value="<?php echo htmlspecialchars($nazev); ?>" required>
        ...
        <?php if(!empty($cesta_k_obrazku)): ?>
            <img src="<?php echo htmlspecialchars($cesta_k_obrazku); ?>" alt="Nahraný obrázek" class="preview-img">
        <?php endif; ?>

        <label for="is_published">Publikovat:</label>
        <input type="checkbox" name="is_published" id="is_published" value="1" <?php if($is_published) echo 'checked'; ?>>
